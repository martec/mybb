...
$inserts[] = "INSERT INTO mybb_profilefields (fid, name, description, disporder, contact, type, regex, length, maxlength, required, registration, profile, postbit, viewableby, editableby, postnum) VALUES (1, 'Location', 'Where in the world do you live?', 1, 0, 'text', '', 0, 255, 0, 0, 1, 0, -1, -1, 0);";
$inserts[] = "INSERT INTO mybb_profilefields (fid, name, description, disporder, contact, type, regex, length, maxlength, required, registration, profile, postbit, viewableby, editableby, postnum) VALUES (2, 'Bio', 'Enter a few short details about yourself, your life story etc.', 2, 0, 'textarea', '', 0, 0, 0, 0, 1, 0, -1, -1, 0);";
$inserts[] = "INSERT INTO mybb_profilefields (fid, name, description, disporder, contact, type, regex, length, maxlength, required, registration, profile, postbit, viewableby, editableby, postnum) VALUES (3, 'Gender', 'Please select your gender from the list below.', 3, 0, 'select\nUndisclosed\nMale\nFemale\nOther', '', 0, 0, 0, 0, 1, 0, -1, -1, 0);";
$inserts[] = "INSERT INTO mybb_profilefields (fid, name, description, disporder, contact, type, regex, length, maxlength, required, registration, profile, postbit, viewableby, editableby, postnum) VALUES (4, 'Facebook', 'What is your Facebook username?', 1, 1, 'text', '', 0, 255, 0, 0, 1, 0, -1, -1, 0);";
$inserts[] = "INSERT INTO mybb_profilefields (fid, name, description, disporder, contact, type, regex, length, maxlength, required, registration, profile, postbit, viewableby, editableby, postnum) VALUES (5, 'Twitter', 'What is your Twitter username?', 2, 1, 'text', '^[a-zA-Z0-9_]+$', 0, 15, 0, 0, 1, 0, -1, -1, 0);";
$inserts[] = "INSERT INTO mybb_profilefields (fid, name, description, disporder, contact, type, regex, length, maxlength, required, registration, profile, postbit, viewableby, editableby, postnum) VALUES (6, 'Skype', 'What is your Skype ID?', 3, 1, 'text', '^[a-zA-Z0-9-_.,@:]+$', 0, 35, 0, 0, 1, 0, -1, -1, 0);";
...
$inserts[] = "INSERT INTO mybb_templategroups (gid,prefix,title,isdefault) VALUES ('1','announcements','<lang:group_announcements>','1');";
$inserts[] = "INSERT INTO mybb_templategroups (gid,prefix,title,isdefault) VALUES ('2','calendar','<lang:group_calendar>','1');";
$inserts[] = "INSERT INTO mybb_templategroups (gid,prefix,title,isdefault) VALUES ('3','contact','<lang:group_contact>','1');";
$inserts[] = "INSERT INTO mybb_templategroups (gid,prefix,title,isdefault) VALUES ('4','editpost','<lang:group_editpost>','1');";
$inserts[] = "INSERT INTO mybb_templategroups (gid,prefix,title,isdefault) VALUES ('5','error','<lang:group_error>','1');";
$inserts[] = "INSERT INTO mybb_templategroups (gid,prefix,title,isdefault) VALUES ('6','forumbit','<lang:group_forumbit>','1');";
$inserts[] = "INSERT INTO mybb_templategroups (gid,prefix,title,isdefault) VALUES ('7','forumdisplay','<lang:group_forumdisplay>','1');";
$inserts[] = "INSERT INTO mybb_templategroups (gid,prefix,title,isdefault) VALUES ('8','header','<lang:group_header>','1');";
$inserts[] = "INSERT INTO mybb_templategroups (gid,prefix,title,isdefault) VALUES ('9','index','<lang:group_index>','1');";
$inserts[] = "INSERT INTO mybb_templategroups (gid,prefix,title,isdefault) VALUES ('10','layouts','<lang:group_layouts>','1');";
$inserts[] = "INSERT INTO mybb_templategroups (gid,prefix,title,isdefault) VALUES ('11','managegroup','<lang:group_managegroup>','1');";
$inserts[] = "INSERT INTO mybb_templategroups (gid,prefix,title,isdefault) VALUES ('12','member','<lang:group_member>','1');";
$inserts[] = "INSERT INTO mybb_templategroups (gid,prefix,title,isdefault) VALUES ('13','memberlist','<lang:group_memberlist>','1');";
$inserts[] = "INSERT INTO mybb_templategroups (gid,prefix,title,isdefault) VALUES ('14','messages','<lang:group_messages>','1');";
$inserts[] = "INSERT INTO mybb_templategroups (gid,prefix,title,isdefault) VALUES ('15','misc','<lang:group_misc>','1');";
$inserts[] = "INSERT INTO mybb_templategroups (gid,prefix,title,isdefault) VALUES ('16','modals','<lang:group_modals>','1');";
$inserts[] = "INSERT INTO mybb_templategroups (gid,prefix,title,isdefault) VALUES ('17','modcp','<lang:group_modcp>','1');";
$inserts[] = "INSERT INTO mybb_templategroups (gid,prefix,title,isdefault) VALUES ('18','moderation','<lang:group_moderation>','1');";
$inserts[] = "INSERT INTO mybb_templategroups (gid,prefix,title,isdefault) VALUES ('19','newreply','<lang:group_newreply>','1');";
$inserts[] = "INSERT INTO mybb_templategroups (gid,prefix,title,isdefault) VALUES ('20','newthread','<lang:group_newthread>','1');";
$inserts[] = "INSERT INTO mybb_templategroups (gid,prefix,title,isdefault) VALUES ('21','online','<lang:group_online>','1');";
$inserts[] = "INSERT INTO mybb_templategroups (gid,prefix,title,isdefault) VALUES ('22','parser','<lang:group_parser>','1');";
$inserts[] = "INSERT INTO mybb_templategroups (gid,prefix,title,isdefault) VALUES ('23','partials','<lang:group_partials>','1');";
$inserts[] = "INSERT INTO mybb_templategroups (gid,prefix,title,isdefault) VALUES ('24','polls','<lang:group_polls>','1');";
$inserts[] = "INSERT INTO mybb_templategroups (gid,prefix,title,isdefault) VALUES ('25','portal','<lang:group_portal>','1');";
$inserts[] = "INSERT INTO mybb_templategroups (gid,prefix,title,isdefault) VALUES ('26','postbit','<lang:group_postbit>','1');";
$inserts[] = "INSERT INTO mybb_templategroups (gid,prefix,title,isdefault) VALUES ('27','printthread','<lang:group_printthread>','1');";
$inserts[] = "INSERT INTO mybb_templategroups (gid,prefix,title,isdefault) VALUES ('28','private','<lang:group_private>','1');";
$inserts[] = "INSERT INTO mybb_templategroups (gid,prefix,title,isdefault) VALUES ('29','referrals','<lang:group_referrals>','1');";
$inserts[] = "INSERT INTO mybb_templategroups (gid,prefix,title,isdefault) VALUES ('30','report','<lang:group_report>','1');";
$inserts[] = "INSERT INTO mybb_templategroups (gid,prefix,title,isdefault) VALUES ('31','reputation','<lang:group_reputation>','1');";
$inserts[] = "INSERT INTO mybb_templategroups (gid,prefix,title,isdefault) VALUES ('32','search','<lang:group_search>','1');";
$inserts[] = "INSERT INTO mybb_templategroups (gid,prefix,title,isdefault) VALUES ('33','sendthread','<lang:group_sendthread>','1');";
$inserts[] = "INSERT INTO mybb_templategroups (gid,prefix,title,isdefault) VALUES ('34','showteam','<lang:group_showteam>','1');";
$inserts[] = "INSERT INTO mybb_templategroups (gid,prefix,title,isdefault) VALUES ('35','showthread','<lang:group_showthread>','1');";
...
$inserts[] = "INSERT INTO mybb_templategroups (gid,prefix,title,isdefault) VALUES ('38','usercp','<lang:group_usercp>','1');";
$inserts[] = "INSERT INTO mybb_templategroups (gid,prefix,title,isdefault) VALUES ('39','warnings','<lang:group_warnings>','1');";
$inserts[] = "INSERT INTO mybb_templategroups (gid,prefix,title,isdefault) VALUES ('40','xmlhttp','<lang:group_xmlhttp>','1');";
